...
class PregnantWomanMonitoring(models.Model):
    ...
    systolic_blood_pressure = models.CharField('Артериальное давление систолическое (мм.рт.ст.)', max_length=50, blank=True, null=True)
    blood_pressure_diastolic = models.CharField('Артериальное давление диастолическое (мм.рт.ст.)', max_length=50, blank=True, null=True)
...
class Doctor(models.Model):
    ...
    access       = models.BooleanField('Доступ', default=True)
