# Generated by Django 4.1.2 on 2022-11-22 18:54
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('home', '0026_alter_appointmentlist_service_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='currentpregnancyinfo',
            name='pregnancy',
            field=models.CharField(blank=True, choices=[('3', 'Наступила спонтанно'), ('', ''), ('1', 'Первая'), ('2', 'Повторная'), ('4', 'Индуцирована с помощью ВРТ')], max_length=1, verbose_name='Беременность'),
        ),
        migrations.AlterField(
            model_name='currentpregnancyinfo',
            name='pregnancy_1',
        ...
        migrations.AlterField(
            model_name='doctor',
            name='email',
            field=models.EmailField(default='None', max_length=60, verbose_name='Email'),
        ),
        migrations.AlterField(
            model_name='doctor',
            name='role',
            field=models.CharField(choices=[('obstetrician-gynecologist', 'Акушер-гинеколог'), ('dentist', 'Стоматолог'), ('therapist', 'Терапевт'), ('receptionist', 'Регистратор'), ('', ''), ('ophthalmologist', 'Офтальмолог'), ('nurse', 'Медсестра'), ('specialist', 'Специалист'), ('pediator', 'Педиатор'), ('assistant', 'Лаборант')], default='----', max_length=30, verbose_name='Должность врача'),
        ),
        migrations.AlterField(
            model_name='doctor',
            name='territory',
            field=models.CharField(choices=[('Новоспасский', 'Новоспасский район'), ('Тереньгульский', 'Тереньгульский район'), ('Инзенский', 'Инзенский район'), ('Ульяновский', 'Ульяновский район'), ('Кузоватовский', 'Кузоватовский район'), ('Сурский', 'Сурский район'), ('Новомалыклинский', 'Новомалыклинский район'), ('Чердаклинский', 'Чердаклинский район '), ('Старокулаткинский', 'Старокулаткинский район'), ('Николаевский', 'Николаевский район'), ('Павловский', 'Павловский район'), ('Мелекесский', 'Мелекесский район'), ('', ''), ('Цильнинский', 'Цильнинский район'), ('Майнский', 'Майнский район'), ('Вешкаймский', 'Вешкаймский район'), ('Старомайнский', 'Старомайнский район'), ('Карсунский', 'Карсунский район'), ('Радищевский', 'Радищевский район'), ('Базарносызганский', 'Базарносызганский район'), ('Барышский', 'Барышский район'), ('Сенгилеевский', 'Сенгилеевский район')], default='Ульяновский', max_length=25, verbose_name='Территория'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            field=models.CharField(blank=True, choices=[('1', 'По женскому типу'), ('5', 'Избыточно выражена'), ('', ''), ('3', 'Недостаточно выражена'), ('4', 'Нормально выражена'), ('2', 'По мужскому типу')], max_length=1, verbose_name='Распределение и выраженность подкожной жировой клетчатки'),
        ),
        migrations.AlterField(
            model_name='firstexamination',
        ...
        migrations.AlterField(
            model_name='medicalcard',
            name='marital_status',
            field=models.CharField(blank=True, choices=[('4', 'Вдова'), ('5', 'Разведена'), ('3', 'Состоит в незарегистрированном браке'), ('2', 'Состоит в зарегистрированном браке'), ('6', 'Разошлась'), ('', '----'), ('1', 'Никогда не состояла в браке')], default='', max_length=1, null=True, verbose_name='Брачное состояние'),
        ),
        migrations.AlterField(
            model_name='medicalcard',
        ...
        migrations.AlterField(
            ...
            name='outcome',
            field=models.CharField(blank=True, choices=[('5', 'Неразвивающаяся беременность'), ('3', 'Самопроизовльный выкидыш'), ('', ''), ('2', 'Кесарево сечение'), ('6', 'Пузырный занос'), ('4', 'Искусственный аборт'), ('1', 'Срочные/Преждевременные')], max_length=10, null=True, verbose_name='Исход беременности'),
        ),
        migrations.AlterField(
            model_name='previouspregnancy',
        ...
        migrations.AlterField(
            ...
            name='specialization',
            field=models.CharField(choices=[('obstetrician-gynecologist', 'Акушер-гинеколог'), ('dentist', 'Стоматолог'), ('therapist', 'Терапевт'), ('receptionist', 'Регистратор'), ('', ''), ('ophthalmologist', 'Офтальмолог'), ('nurse', 'Медсестра'), ('specialist', 'Специалист'), ('pediator', 'Педиатор'), ('assistant', 'Лаборант')], max_length=30, verbose_name='Специальность врача'),
        ),
        migrations.AlterField(
