# Generated by Django 4.1 on 2023-03-30 18:55
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='doctor',
            name='role',
            field=models.CharField(choices=[('specialist', 'Специалист'), ('', ''), ('obstetrician-gynecologist', 'Акушер-гинеколог'), ('dentist', 'Стоматолог'), ('nurse', 'Медсестра'), ('ophthalmologist', 'Офтальмолог'), ('assistant', 'Лаборант'), ('receptionist', 'Регистратор'), ('therapist', 'Терапевт'), ('pediator', 'Педиатр')], default='----', max_length=30, verbose_name='Должность врача'),
        ),
        migrations.AlterField(
            model_name='doctor',
            name='territory',
            field=models.CharField(choices=[('Старокулаткинский', 'Старокулаткинский район'), ('Майнский', 'Майнский район'), ('Мелекесский', 'Мелекесский район'), ('Ульяновский', 'Ульяновский район'), ('Павловский', 'Павловский район'), ('Радищевский', 'Радищевский район'), ('Тереньгульский', 'Тереньгульский район'), ('Николаевский', 'Николаевский район'), ('', '-----'), ('Базарносызганский', 'Базарносызганский район'), ('Барышский', 'Барышский район'), ('Сенгилеевский', 'Сенгилеевский район'), ('Старомайнский', 'Старомайнский район'), ('Кузоватовский', 'Кузоватовский район'), ('Карсунский', 'Карсунский район'), ('Сурский', 'Сурский район'), ('Чердаклинский', 'Чердаклинский район '), ('Инзенский', 'Инзенский район'), ('Цильнинский', 'Цильнинский район'), ('Новоспасский', 'Новоспасский район'), ('Вешкаймский', 'Вешкаймский район'), ('Новомалыклинский', 'Новомалыклинский район')], default='Ульяновский', max_length=25, verbose_name='Территория'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            field=models.CharField(blank=True, choices=[('1', 'По женскому типу'), ('', '-----'), ('2', 'По мужскому типу'), ('4', 'Нормально выражена'), ('3', 'Недостаточно выражена'), ('5', 'Избыточно выражена')], max_length=1, verbose_name='Распределение и выраженность подкожной жировой клетчатки'),
        ),
        migrations.AlterField(
            model_name='firstexamination',
        ...
        migrations.AlterField(
            model_name='medicalcard',
            name='marital_status',
            field=models.CharField(blank=True, choices=[('6', 'Разошлась'), ('4', 'Вдова'), ('2', 'Состоит в зарегистрированном браке'), ('1', 'Никогда не состояла в браке'), ('', '----'), ('3', 'Состоит в незарегистрированном браке'), ('5', 'Разведена')], default='', max_length=1, null=True, verbose_name='Брачное состояние'),
        ),
        migrations.AlterField(
            model_name='medicalcard',
        ...
        migrations.AlterField(
            ...
            name='outcome',
            field=models.CharField(blank=True, choices=[('', '-----'), ('5', 'Неразвивающаяся беременность'), ('4', 'Искусственный аборт'), ('1', 'Срочные/Преждевременные'), ('2', 'Кесарево сечение'), ('6', 'Пузырный занос'), ('3', 'Самопроизовльный выкидыш')], max_length=10, null=True, verbose_name='Исход беременности'),
        ),
        migrations.AlterField(
            model_name='previouspregnancy',
        ...
        migrations.AlterField(
            ...
            name='specialization',
            field=models.CharField(blank=True, choices=[('specialist', 'Специалист'), ('', ''), ('obstetrician-gynecologist', 'Акушер-гинеколог'), ('dentist', 'Стоматолог'), ('nurse', 'Медсестра'), ('ophthalmologist', 'Офтальмолог'), ('assistant', 'Лаборант'), ('receptionist', 'Регистратор'), ('therapist', 'Терапевт'), ('pediator', 'Педиатр')], max_length=30, null=True, verbose_name='Специальность врача'),
        ),
        migrations.AlterField(
            model_name='samd',
            name='sms_status',
            field=models.CharField(blank=True, choices=[('', '-----'), ('5', 'Отправлен'), ('4', 'Готов к отправке'), ('3', 'Не подписан'), ('1', 'Недостаточно данных'), ('2', 'Неправильно введены данные')], max_length=300, verbose_name='Статус версии СМС'),
        ),
        migrations.AlterField(
            model_name='samd',
            name='sms_type',
