...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('home', '0049_alter_appointmentlist_service_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='pregnancy',
            field=models.CharField(blank=True, choices=[('3', 'Наступила спонтанно'), ('2', 'Повторная'), ('4', 'Индуцирована с помощью ВРТ'), ('', '-----'), ('1', 'Первая')], max_length=1, verbose_name='Беременность'),
        ),
        migrations.AlterField(
            model_name='currentpregnancyinfo',
            name='pregnancy_1',
        ...
        migrations.AlterField(
            model_name='doctor',
            name='role',
            field=models.CharField(choices=[('nurse', 'Медсестра'), ('', ''), ('pediator', 'Педиатр'), ('assistant', 'Лаборант'), ('therapist', 'Терапевт'), ('dentist', 'Стоматолог'), ('obstetrician-gynecologist', 'Акушер-гинеколог'), ('ophthalmologist', 'Офтальмолог'), ('specialist', 'Специалист'), ('receptionist', 'Регистратор')], default='----', max_length=30, verbose_name='Должность врача'),
        ),
        migrations.AlterField(
            model_name='doctor',
            name='territory',
            field=models.CharField(choices=[('Чердаклинский', 'Чердаклинский район '), ('Мелекесский', 'Мелекесский район'), ('', '-----'), ('Николаевский', 'Николаевский район'), ('Инзенский', 'Инзенский район'), ('Кузоватовский', 'Кузоватовский район'), ('Сенгилеевский', 'Сенгилеевский район'), ('Старокулаткинский', 'Старокулаткинский район'), ('Карсунский', 'Карсунский район'), ('Сурский', 'Сурский район'), ('Цильнинский', 'Цильнинский район'), ('Старомайнский', 'Старомайнский район'), ('Базарносызганский', 'Базарносызганский район'), ('Вешкаймский', 'Вешкаймский район'), ('Новомалыклинский', 'Новомалыклинский район'), ('Павловский', 'Павловский район'), ('Радищевский', 'Радищевский район'), ('Тереньгульский', 'Тереньгульский район'), ('Новоспасский', 'Новоспасский район'), ('Барышский', 'Барышский район'), ('Майнский', 'Майнский район'), ('Ульяновский', 'Ульяновский район')], default='Ульяновский', max_length=25, verbose_name='Территория'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='medicalcard',
            name='marital_status',
            field=models.CharField(blank=True, choices=[('4', 'Вдова'), ('6', 'Разошлась'), ('2', 'Состоит в зарегистрированном браке'), ('', '----'), ('5', 'Разведена'), ('3', 'Состоит в незарегистрированном браке'), ('1', 'Никогда не состояла в браке')], default='', max_length=1, null=True, verbose_name='Брачное состояние'),
        ),
        migrations.AlterField(
            model_name='medicalcard',
        ...
        migrations.AlterField(
            ...
            name='delivery',
            field=models.CharField(blank=True, choices=[('', '-----'), ('2', 'Второй уровень'), ('1', 'Первый уровень'), ('3', 'Третий уровень')], max_length=10, null=True, verbose_name='МО родоразрешения'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            name='outcome',
            field=models.CharField(blank=True, choices=[('6', 'Пузырный занос'), ('3', 'Самопроизовльный выкидыш'), ('5', 'Неразвивающаяся беременность'), ('2', 'Кесарево сечение'), ('1', 'Срочные/Преждевременные'), ('', '-----'), ('4', 'Искусственный аборт')], max_length=10, null=True, verbose_name='Исход беременности'),
        ),
        migrations.AlterField(
            model_name='previouspregnancy',
        ...
        migrations.AlterField(
            ...
            name='specialization',
            field=models.CharField(blank=True, choices=[('nurse', 'Медсестра'), ('', ''), ('pediator', 'Педиатр'), ('assistant', 'Лаборант'), ('therapist', 'Терапевт'), ('dentist', 'Стоматолог'), ('obstetrician-gynecologist', 'Акушер-гинеколог'), ('ophthalmologist', 'Офтальмолог'), ('specialist', 'Специалист'), ('receptionist', 'Регистратор')], max_length=30, null=True, verbose_name='Специальность врача'),
        ),
        migrations.AlterField(
            model_name='samd',
            name='sms_status',
            field=models.CharField(blank=True, choices=[('4', 'Готов к отправке'), ('3', 'Не подписан'), ('1', 'Недостаточно данных'), ('', '-----'), ('2', 'Неправильно введены данные'), ('5', 'Отправлен')], max_length=300, verbose_name='Статус версии СМС'),
        ),
        migrations.AlterField(
            model_name='samd',
            name='sms_type',
