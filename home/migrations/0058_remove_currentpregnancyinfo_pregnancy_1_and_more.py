# Generated by Django 4.1 on 2023-04-22 18:56
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('home', '0057_currentpregnancyinfo_pregnancy_start_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='doctor',
            name='role',
            field=models.CharField(choices=[('receptionist', 'Регистратор'), ('', ''), ('specialist', 'Специалист'), ('dentist', 'Стоматолог'), ('assistant', 'Лаборант'), ('ophthalmologist', 'Офтальмолог'), ('obstetrician-gynecologist', 'Акушер-гинеколог'), ('therapist', 'Терапевт'), ('nurse', 'Медсестра'), ('pediator', 'Педиатр')], default='----', max_length=30, verbose_name='Должность врача'),
        ),
        migrations.AlterField(
            model_name='doctor',
            name='territory',
            field=models.CharField(choices=[('Ульяновский', 'Ульяновский район'), ('Базарносызганский', 'Базарносызганский район'), ('Старомайнский', 'Старомайнский район'), ('Цильнинский', 'Цильнинский район'), ('Чердаклинский', 'Чердаклинский район '), ('Вешкаймский', 'Вешкаймский район'), ('Барышский', 'Барышский район'), ('Кузоватовский', 'Кузоватовский район'), ('Карсунский', 'Карсунский район'), ('Николаевский', 'Николаевский район'), ('Павловский', 'Павловский район'), ('Радищевский', 'Радищевский район'), ('Новомалыклинский', 'Новомалыклинский район'), ('Сенгилеевский', 'Сенгилеевский район'), ('Майнский', 'Майнский район'), ('', '-----'), ('Мелекесский', 'Мелекесский район'), ('Сурский', 'Сурский район'), ('Инзенский', 'Инзенский район'), ('Тереньгульский', 'Тереньгульский район'), ('Старокулаткинский', 'Старокулаткинский район'), ('Новоспасский', 'Новоспасский район')], default='Ульяновский', max_length=25, verbose_name='Территория'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            field=models.CharField(blank=True, choices=[('5', 'Избыточно выражена'), ('3', 'Недостаточно выражена'), ('1', 'По женскому типу'), ('4', 'Нормально выражена'), ('', '-----'), ('2', 'По мужскому типу')], max_length=1, verbose_name='Распределение и выраженность подкожной жировой клетчатки'),
        ),
        migrations.AlterField(
            model_name='firstexamination',
        ...
        migrations.AlterField(
            ...
            field=models.CharField(blank=True, choices=[('2', 'A(II)'), ('4', 'AB(IV)'), ('3', 'B(III)'), ('1', 'O(I)'), ('', '-----')], max_length=1, null=True, verbose_name='Группа крови отца ребенка'),
        ),
        migrations.AlterField(
            model_name='medicalcard',
        ...
        migrations.AlterField(
            model_name='medicalcard',
            name='marital_status',
            field=models.CharField(blank=True, choices=[('1', 'Никогда не состояла в браке'), ('6', 'Разошлась'), ('', '----'), ('5', 'Разведена'), ('3', 'Состоит в незарегистрированном браке'), ('4', 'Вдова'), ('2', 'Состоит в зарегистрированном браке')], default='', max_length=1, null=True, verbose_name='Брачное состояние'),
        ),
        migrations.AlterField(
            model_name='medicalcard',
        ...
        migrations.AlterField(
            ...
            name='outcome',
            field=models.CharField(blank=True, choices=[('3', 'Самопроизовльный выкидыш'), ('2', 'Кесарево сечение'), ('', '-----'), ('1', 'Срочные/Преждевременные'), ('6', 'Пузырный занос'), ('4', 'Искусственный аборт'), ('5', 'Неразвивающаяся беременность')], max_length=10, null=True, verbose_name='Исход беременности'),
        ),
        migrations.AlterField(
            model_name='previouspregnancy',
        ...
        migrations.AlterField(
            model_name='samd',
            name='sms_type',
            field=models.CharField(blank=True, choices=[('4', ''), ('9', 'Выявление заключения по результатам расчета индивидуального риска беременной'), ('', '-----'), ('3', 'Выявление диагностических исследований'), ('8', 'Выявление извещения о критическом акушерском состоянии'), ('5', 'Выявление госпитализации (получение пациентом медицинской помощи в условиях стационара (дневного стационара))'), ('2', 'Выявление факта постановки на учет по беременности'), ('1', 'Выявление осмотра (консультации) пациента'), ('7', ''), ('6', 'Выявление факта завершения беременности')], max_length=10, verbose_name='Тип СМС'),
        ),
        migrations.AlterField(
