# Generated by Django 4.1 on 2022-12-28 03:30
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('home', '0051_samd_was_send_alter_appointmentlist_service_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('msg_id', models.CharField(blank=True, max_length=300, verbose_name='Идентификатор сообщения')),
            ],
        ),
        ...
        migrations.AlterField(
            model_name='doctor',
            name='role',
            field=models.CharField(choices=[('ophthalmologist', 'Офтальмолог'), ('specialist', 'Специалист'), ('', ''), ('nurse', 'Медсестра'), ('pediator', 'Педиатр'), ('dentist', 'Стоматолог'), ('receptionist', 'Регистратор'), ('assistant', 'Лаборант'), ('therapist', 'Терапевт'), ('obstetrician-gynecologist', 'Акушер-гинеколог')], default='----', max_length=30, verbose_name='Должность врача'),
        ),
        migrations.AlterField(
            model_name='doctor',
            name='territory',
            field=models.CharField(choices=[('Карсунский', 'Карсунский район'), ('', '-----'), ('Базарносызганский', 'Базарносызганский район'), ('Ульяновский', 'Ульяновский район'), ('Сенгилеевский', 'Сенгилеевский район'), ('Тереньгульский', 'Тереньгульский район'), ('Инзенский', 'Инзенский район'), ('Цильнинский', 'Цильнинский район'), ('Николаевский', 'Николаевский район'), ('Вешкаймский', 'Вешкаймский район'), ('Новомалыклинский', 'Новомалыклинский район'), ('Новоспасский', 'Новоспасский район'), ('Майнский', 'Майнский район'), ('Барышский', 'Барышский район'), ('Павловский', 'Павловский район'), ('Радищевский', 'Радищевский район'), ('Сурский', 'Сурский район'), ('Старокулаткинский', 'Старокулаткинский район'), ('Мелекесский', 'Мелекесский район'), ('Кузоватовский', 'Кузоватовский район'), ('Чердаклинский', 'Чердаклинский район '), ('Старомайнский', 'Старомайнский район')], default='Ульяновский', max_length=25, verbose_name='Территория'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            field=models.CharField(blank=True, choices=[('1', 'O(I)'), ('2', 'A(II)'), ('4', 'AB(IV)'), ('', '-----'), ('3', 'B(III)')], max_length=1, null=True, verbose_name='Группа крови отца ребенка'),
        ),
        migrations.AlterField(
            model_name='medicalcard',
        ...
        migrations.AlterField(
            model_name='medicalcard',
            name='marital_status',
            field=models.CharField(blank=True, choices=[('3', 'Состоит в незарегистрированном браке'), ('1', 'Никогда не состояла в браке'), ('', '----'), ('6', 'Разошлась'), ('2', 'Состоит в зарегистрированном браке'), ('5', 'Разведена'), ('4', 'Вдова')], default='', max_length=1, null=True, verbose_name='Брачное состояние'),
        ),
        migrations.AlterField(
            model_name='medicalcard',
        ...
        migrations.AlterField(
            ...
            name='outcome',
            field=models.CharField(blank=True, choices=[('5', 'Неразвивающаяся беременность'), ('1', 'Срочные/Преждевременные'), ('3', 'Самопроизовльный выкидыш'), ('', '-----'), ('4', 'Искусственный аборт'), ('2', 'Кесарево сечение'), ('6', 'Пузырный занос')], max_length=10, null=True, verbose_name='Исход беременности'),
        ),
        migrations.AlterField(
            model_name='previouspregnancy',
        ...
        migrations.AlterField(
            ...
            name='specialization',
            field=models.CharField(blank=True, choices=[('ophthalmologist', 'Офтальмолог'), ('specialist', 'Специалист'), ('', ''), ('nurse', 'Медсестра'), ('pediator', 'Педиатр'), ('dentist', 'Стоматолог'), ('receptionist', 'Регистратор'), ('assistant', 'Лаборант'), ('therapist', 'Терапевт'), ('obstetrician-gynecologist', 'Акушер-гинеколог')], max_length=30, null=True, verbose_name='Специальность врача'),
        ),
        migrations.AlterField(
            model_name='samd',
            name='sms_status',
            field=models.CharField(blank=True, choices=[('5', 'Отправлен'), ('1', 'Недостаточно данных'), ('2', 'Неправильно введены данные'), ('4', 'Готов к отправке'), ('', '-----'), ('3', 'Не подписан')], max_length=300, verbose_name='Статус версии СМС'),
        ),
        migrations.AlterField(
            model_name='samd',
            name='sms_type',
            field=models.CharField(blank=True, choices=[('1', 'Выявление осмотра (консультации) пациента'), ('', '-----'), ('2', 'Выявление госпитализации (получение пациентом медицинской помощи в условиях стационара (дневного стационара))')], max_length=10, verbose_name='Тип СМС'),
        ),
        migrations.AlterField(
