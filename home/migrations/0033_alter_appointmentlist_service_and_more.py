# Generated by Django 4.1 on 2022-12-02 15:46
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('home', '0032_remove_samd_date_of_birth_remove_samd_patient_fio_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='doctor',
            name='role',
            field=models.CharField(choices=[('therapist', 'Терапевт'), ('obstetrician-gynecologist', 'Акушер-гинеколог'), ('nurse', 'Медсестра'), ('', ''), ('pediator', 'Педиатр'), ('specialist', 'Специалист'), ('assistant', 'Лаборант'), ('dentist', 'Стоматолог'), ('ophthalmologist', 'Офтальмолог'), ('receptionist', 'Регистратор')], default='----', max_length=30, verbose_name='Должность врача'),
        ),
        migrations.AlterField(
            model_name='doctor',
            name='territory',
            field=models.CharField(choices=[('Новоспасский', 'Новоспасский район'), ('Барышский', 'Барышский район'), ('Цильнинский', 'Цильнинский район'), ('Чердаклинский', 'Чердаклинский район '), ('Старомайнский', 'Старомайнский район'), ('Вешкаймский', 'Вешкаймский район'), ('Радищевский', 'Радищевский район'), ('Базарносызганский', 'Базарносызганский район'), ('Кузоватовский', 'Кузоватовский район'), ('Новомалыклинский', 'Новомалыклинский район'), ('Тереньгульский', 'Тереньгульский район'), ('Ульяновский', 'Ульяновский район'), ('Мелекесский', 'Мелекесский район'), ('Сурский', 'Сурский район'), ('', ''), ('Карсунский', 'Карсунский район'), ('Инзенский', 'Инзенский район'), ('Майнский', 'Майнский район'), ('Павловский', 'Павловский район'), ('Сенгилеевский', 'Сенгилеевский район'), ('Старокулаткинский', 'Старокулаткинский район'), ('Николаевский', 'Николаевский район')], default='Ульяновский', max_length=25, verbose_name='Территория'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='medicalcard',
            name='marital_status',
            field=models.CharField(blank=True, choices=[('2', 'Состоит в зарегистрированном браке'), ('5', 'Разведена'), ('4', 'Вдова'), ('', '----'), ('1', 'Никогда не состояла в браке'), ('6', 'Разошлась'), ('3', 'Состоит в незарегистрированном браке')], default='', max_length=1, null=True, verbose_name='Брачное состояние'),
        ),
        migrations.AlterField(
            model_name='medicalcard',
        ...
        migrations.AlterField(
            ...
            name='outcome',
            field=models.CharField(blank=True, choices=[('4', 'Искусственный аборт'), ('6', 'Пузырный занос'), ('5', 'Неразвивающаяся беременность'), ('', ''), ('1', 'Срочные/Преждевременные'), ('3', 'Самопроизовльный выкидыш'), ('2', 'Кесарево сечение')], max_length=10, null=True, verbose_name='Исход беременности'),
        ),
        migrations.AlterField(
            model_name='previouspregnancy',
        ...
        migrations.AlterField(
            ...
            name='specialization',
            field=models.CharField(choices=[('therapist', 'Терапевт'), ('obstetrician-gynecologist', 'Акушер-гинеколог'), ('nurse', 'Медсестра'), ('', ''), ('pediator', 'Педиатр'), ('specialist', 'Специалист'), ('assistant', 'Лаборант'), ('dentist', 'Стоматолог'), ('ophthalmologist', 'Офтальмолог'), ('receptionist', 'Регистратор')], max_length=30, verbose_name='Специальность врача'),
        ),
        migrations.AlterField(
            model_name='samd',
            name='sms_status',
            field=models.CharField(blank=True, choices=[('3', 'Не подписан'), ('4', 'Готов к отправке'), ('', ''), ('2', 'Неправильно введены данные'), ('5', 'Отправлен'), ('1', 'Недостаточно данных')], max_length=300, verbose_name='Статус версии СМС'),
        ),
        migrations.AlterField(
            model_name='samd',
            name='sms_type',
        ...
        migrations.AlterField(
            model_name='samd',
            name='trigger',
            field=models.CharField(blank=True, max_length=300, verbose_name='Триггер'),
        ),
        migrations.AlterField(
