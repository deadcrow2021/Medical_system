# Generated by Django 4.1 on 2023-03-28 14:40
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='doctor',
            name='role',
            field=models.CharField(choices=[('', ''), ('pediator', 'Педиатр'), ('therapist', 'Терапевт'), ('receptionist', 'Регистратор'), ('dentist', 'Стоматолог'), ('nurse', 'Медсестра'), ('specialist', 'Специалист'), ('assistant', 'Лаборант'), ('obstetrician-gynecologist', 'Акушер-гинеколог'), ('ophthalmologist', 'Офтальмолог')], default='----', max_length=30, verbose_name='Должность врача'),
        ),
        migrations.AlterField(
            model_name='doctor',
            name='territory',
            field=models.CharField(choices=[('Инзенский', 'Инзенский район'), ('Базарносызганский', 'Базарносызганский район'), ('Радищевский', 'Радищевский район'), ('Тереньгульский', 'Тереньгульский район'), ('Старокулаткинский', 'Старокулаткинский район'), ('Старомайнский', 'Старомайнский район'), ('Чердаклинский', 'Чердаклинский район '), ('Николаевский', 'Николаевский район'), ('Новоспасский', 'Новоспасский район'), ('Вешкаймский', 'Вешкаймский район'), ('', '-----'), ('Цильнинский', 'Цильнинский район'), ('Сурский', 'Сурский район'), ('Майнский', 'Майнский район'), ('Барышский', 'Барышский район'), ('Карсунский', 'Карсунский район'), ('Павловский', 'Павловский район'), ('Ульяновский', 'Ульяновский район'), ('Новомалыклинский', 'Новомалыклинский район'), ('Кузоватовский', 'Кузоватовский район'), ('Мелекесский', 'Мелекесский район'), ('Сенгилеевский', 'Сенгилеевский район')], default='Ульяновский', max_length=25, verbose_name='Территория'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            field=models.CharField(blank=True, choices=[('4', 'Нормально выражена'), ('1', 'По женскому типу'), ('2', 'По мужскому типу'), ('5', 'Избыточно выражена'), ('', '-----'), ('3', 'Недостаточно выражена')], max_length=1, verbose_name='Распределение и выраженность подкожной жировой клетчатки'),
        ),
        migrations.AlterField(
            model_name='firstexamination',
        ...
        migrations.AlterField(
            ...
            field=models.CharField(blank=True, choices=[('3', 'B(III)'), ('2', 'A(II)'), ('4', 'AB(IV)'), ('1', 'O(I)'), ('', '-----')], max_length=1, null=True, verbose_name='Группа крови отца ребенка'),
        ),
        migrations.AlterField(
            model_name='medicalcard',
        ...
        migrations.AlterField(
            model_name='medicalcard',
            name='marital_status',
            field=models.CharField(blank=True, choices=[('1', 'Никогда не состояла в браке'), ('', '----'), ('6', 'Разошлась'), ('4', 'Вдова'), ('5', 'Разведена'), ('3', 'Состоит в незарегистрированном браке'), ('2', 'Состоит в зарегистрированном браке')], default='', max_length=1, null=True, verbose_name='Брачное состояние'),
        ),
        migrations.AlterField(
            model_name='medicalcard',
        ...
        migrations.AlterField(
            ...
            name='outcome',
            field=models.CharField(blank=True, choices=[('2', 'Кесарево сечение'), ('6', 'Пузырный занос'), ('1', 'Срочные/Преждевременные'), ('', '-----'), ('4', 'Искусственный аборт'), ('5', 'Неразвивающаяся беременность'), ('3', 'Самопроизовльный выкидыш')], max_length=10, null=True, verbose_name='Исход беременности'),
        ),
        migrations.AlterField(
            model_name='previouspregnancy',
        ...
        migrations.AlterField(
            model_name='samd',
            name='sms_type',
            field=models.CharField(blank=True, choices=[('3', 'Выявление диагностических исследований'), ('5', 'Выявление госпитализации (получение пациентом медицинской помощи в условиях стационара (дневного стационара))'), ('6', 'Выявление факта завершения беременности'), ('2', 'Выявление факта постановки на учет по беременности'), ('9', 'Выявление заключения по результатам расчета индивидуального риска беременной'), ('7', ''), ('1', 'Выявление осмотра (консультации) пациента'), ('8', 'Выявление извещения о критическом акушерском состоянии'), ('', '-----'), ('4', '')], max_length=10, verbose_name='Тип СМС'),
        ),
        migrations.AlterField(
