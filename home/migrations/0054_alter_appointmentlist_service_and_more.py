# Generated by Django 4.1 on 2023-03-30 18:39
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='doctor',
            name='role',
            field=models.CharField(choices=[('therapist', 'Терапевт'), ('pediator', 'Педиатр'), ('', ''), ('obstetrician-gynecologist', 'Акушер-гинеколог'), ('specialist', 'Специалист'), ('ophthalmologist', 'Офтальмолог'), ('nurse', 'Медсестра'), ('receptionist', 'Регистратор'), ('dentist', 'Стоматолог'), ('assistant', 'Лаборант')], default='----', max_length=30, verbose_name='Должность врача'),
        ),
        migrations.AlterField(
            model_name='doctor',
            name='territory',
            field=models.CharField(choices=[('Мелекесский', 'Мелекесский район'), ('Старомайнский', 'Старомайнский район'), ('Радищевский', 'Радищевский район'), ('Сурский', 'Сурский район'), ('Чердаклинский', 'Чердаклинский район '), ('Сенгилеевский', 'Сенгилеевский район'), ('Майнский', 'Майнский район'), ('Новомалыклинский', 'Новомалыклинский район'), ('Базарносызганский', 'Базарносызганский район'), ('Николаевский', 'Николаевский район'), ('Новоспасский', 'Новоспасский район'), ('Тереньгульский', 'Тереньгульский район'), ('Барышский', 'Барышский район'), ('Цильнинский', 'Цильнинский район'), ('Павловский', 'Павловский район'), ('Кузоватовский', 'Кузоватовский район'), ('Старокулаткинский', 'Старокулаткинский район'), ('Вешкаймский', 'Вешкаймский район'), ('Инзенский', 'Инзенский район'), ('', '-----'), ('Ульяновский', 'Ульяновский район'), ('Карсунский', 'Карсунский район')], default='Ульяновский', max_length=25, verbose_name='Территория'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            field=models.CharField(blank=True, choices=[('1', 'По женскому типу'), ('5', 'Избыточно выражена'), ('4', 'Нормально выражена'), ('', '-----'), ('2', 'По мужскому типу'), ('3', 'Недостаточно выражена')], max_length=1, verbose_name='Распределение и выраженность подкожной жировой клетчатки'),
        ),
        migrations.AlterField(
            model_name='firstexamination',
        ...
        migrations.AlterField(
            ...
            field=models.CharField(blank=True, choices=[('4', 'AB(IV)'), ('3', 'B(III)'), ('2', 'A(II)'), ('', '-----'), ('1', 'O(I)')], max_length=1, null=True, verbose_name='Группа крови отца ребенка'),
        ),
        migrations.AlterField(
            model_name='medicalcard',
            name='marital_status',
        ...
        migrations.AlterField(
            ...
            name='outcome',
            field=models.CharField(blank=True, choices=[('1', 'Срочные/Преждевременные'), ('3', 'Самопроизовльный выкидыш'), ('2', 'Кесарево сечение'), ('4', 'Искусственный аборт'), ('', '-----'), ('5', 'Неразвивающаяся беременность'), ('6', 'Пузырный занос')], max_length=10, null=True, verbose_name='Исход беременности'),
        ),
        migrations.AlterField(
            model_name='previouspregnancy',
        ...
        migrations.AlterField(
            ...
            name='specialization',
            field=models.CharField(blank=True, choices=[('therapist', 'Терапевт'), ('pediator', 'Педиатр'), ('', ''), ('obstetrician-gynecologist', 'Акушер-гинеколог'), ('specialist', 'Специалист'), ('ophthalmologist', 'Офтальмолог'), ('nurse', 'Медсестра'), ('receptionist', 'Регистратор'), ('dentist', 'Стоматолог'), ('assistant', 'Лаборант')], max_length=30, null=True, verbose_name='Специальность врача'),
        ),
        migrations.AlterField(
            model_name='samd',
            name='sms_status',
            field=models.CharField(blank=True, choices=[('5', 'Отправлен'), ('3', 'Не подписан'), ('', '-----'), ('2', 'Неправильно введены данные'), ('4', 'Готов к отправке'), ('1', 'Недостаточно данных')], max_length=300, verbose_name='Статус версии СМС'),
        ),
        migrations.AlterField(
            model_name='samd',
            name='sms_type',
