...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('home', '0030_alter_appointmentlist_service_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='doctor',
            name='role',
            field=models.CharField(choices=[('specialist', 'Специалист'), ('', ''), ('receptionist', 'Регистратор'), ('therapist', 'Терапевт'), ('assistant', 'Лаборант'), ('ophthalmologist', 'Офтальмолог'), ('obstetrician-gynecologist', 'Акушер-гинеколог'), ('pediator', 'Педиатр'), ('dentist', 'Стоматолог'), ('nurse', 'Медсестра')], default='----', max_length=30, verbose_name='Должность врача'),
        ),
        migrations.AlterField(
            model_name='doctor',
            name='territory',
            field=models.CharField(choices=[('Майнский', 'Майнский район'), ('Мелекесский', 'Мелекесский район'), ('Чердаклинский', 'Чердаклинский район '), ('Павловский', 'Павловский район'), ('Вешкаймский', 'Вешкаймский район'), ('Инзенский', 'Инзенский район'), ('Старомайнский', 'Старомайнский район'), ('Карсунский', 'Карсунский район'), ('Николаевский', 'Николаевский район'), ('Тереньгульский', 'Тереньгульский район'), ('Базарносызганский', 'Базарносызганский район'), ('Цильнинский', 'Цильнинский район'), ('Новоспасский', 'Новоспасский район'), ('Ульяновский', 'Ульяновский район'), ('Сурский', 'Сурский район'), ('Сенгилеевский', 'Сенгилеевский район'), ('Новомалыклинский', 'Новомалыклинский район'), ('', ''), ('Барышский', 'Барышский район'), ('Радищевский', 'Радищевский район'), ('Старокулаткинский', 'Старокулаткинский район'), ('Кузоватовский', 'Кузоватовский район')], default='Ульяновский', max_length=25, verbose_name='Территория'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            field=models.CharField(blank=True, choices=[('4', 'Нормально выражена'), ('3', 'Недостаточно выражена'), ('2', 'По мужскому типу'), ('', ''), ('5', 'Избыточно выражена'), ('1', 'По женскому типу')], max_length=1, verbose_name='Распределение и выраженность подкожной жировой клетчатки'),
        ),
        migrations.AlterField(
            model_name='firstexamination',
        ...
        migrations.AlterField(
            model_name='medicalcard',
            name='marital_status',
            field=models.CharField(blank=True, choices=[('6', 'Разошлась'), ('2', 'Состоит в зарегистрированном браке'), ('', '----'), ('1', 'Никогда не состояла в браке'), ('3', 'Состоит в незарегистрированном браке'), ('4', 'Вдова'), ('5', 'Разведена')], default='', max_length=1, null=True, verbose_name='Брачное состояние'),
        ),
        migrations.AlterField(
            model_name='medicalcard',
        ...
        migrations.AlterField(
            ...
            name='outcome',
            field=models.CharField(blank=True, choices=[('', ''), ('6', 'Пузырный занос'), ('3', 'Самопроизовльный выкидыш'), ('5', 'Неразвивающаяся беременность'), ('1', 'Срочные/Преждевременные'), ('4', 'Искусственный аборт'), ('2', 'Кесарево сечение')], max_length=10, null=True, verbose_name='Исход беременности'),
        ),
        migrations.AlterField(
            model_name='previouspregnancy',
        ...
        migrations.AlterField(
            ...
            name='specialization',
            field=models.CharField(choices=[('specialist', 'Специалист'), ('', ''), ('receptionist', 'Регистратор'), ('therapist', 'Терапевт'), ('assistant', 'Лаборант'), ('ophthalmologist', 'Офтальмолог'), ('obstetrician-gynecologist', 'Акушер-гинеколог'), ('pediator', 'Педиатр'), ('dentist', 'Стоматолог'), ('nurse', 'Медсестра')], max_length=30, verbose_name='Специальность врача'),
        ),
        migrations.AlterField(
            model_name='samd',
            name='sms_status',
            field=models.CharField(blank=True, choices=[('1', 'Недостаточно данных'), ('2', 'Неправильно введены данные'), ('5', 'Отправлен'), ('', ''), ('4', 'Готов к отправке'), ('3', 'Не подписан')], max_length=300, verbose_name='Статус версии СМС'),
        ),
        migrations.AlterField(
