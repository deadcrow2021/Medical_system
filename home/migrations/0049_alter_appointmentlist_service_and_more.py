...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('home', '0048_remove_turnoutschedule_patient_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='doctor',
            name='role',
            field=models.CharField(choices=[('assistant', 'Лаборант'), ('pediator', 'Педиатр'), ('', ''), ('therapist', 'Терапевт'), ('nurse', 'Медсестра'), ('receptionist', 'Регистратор'), ('obstetrician-gynecologist', 'Акушер-гинеколог'), ('ophthalmologist', 'Офтальмолог'), ('specialist', 'Специалист'), ('dentist', 'Стоматолог')], default='----', max_length=30, verbose_name='Должность врача'),
        ),
        migrations.AlterField(
            model_name='doctor',
            name='territory',
            field=models.CharField(choices=[('Мелекесский', 'Мелекесский район'), ('Карсунский', 'Карсунский район'), ('Майнский', 'Майнский район'), ('', '-----'), ('Базарносызганский', 'Базарносызганский район'), ('Новоспасский', 'Новоспасский район'), ('Сенгилеевский', 'Сенгилеевский район'), ('Новомалыклинский', 'Новомалыклинский район'), ('Кузоватовский', 'Кузоватовский район'), ('Сурский', 'Сурский район'), ('Старомайнский', 'Старомайнский район'), ('Вешкаймский', 'Вешкаймский район'), ('Николаевский', 'Николаевский район'), ('Старокулаткинский', 'Старокулаткинский район'), ('Павловский', 'Павловский район'), ('Цильнинский', 'Цильнинский район'), ('Барышский', 'Барышский район'), ('Тереньгульский', 'Тереньгульский район'), ('Ульяновский', 'Ульяновский район'), ('Инзенский', 'Инзенский район'), ('Чердаклинский', 'Чердаклинский район '), ('Радищевский', 'Радищевский район')], default='Ульяновский', max_length=25, verbose_name='Территория'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            field=models.CharField(blank=True, choices=[('', '-----'), ('3', 'Недостаточно выражена'), ('4', 'Нормально выражена'), ('5', 'Избыточно выражена'), ('2', 'По мужскому типу'), ('1', 'По женскому типу')], max_length=1, verbose_name='Распределение и выраженность подкожной жировой клетчатки'),
        ),
        migrations.AlterField(
            model_name='firstexamination',
        ...
        migrations.AlterField(
            model_name='medicalcard',
            name='marital_status',
            field=models.CharField(blank=True, choices=[('5', 'Разведена'), ('2', 'Состоит в зарегистрированном браке'), ('3', 'Состоит в незарегистрированном браке'), ('6', 'Разошлась'), ('4', 'Вдова'), ('1', 'Никогда не состояла в браке'), ('', '----')], default='', max_length=1, null=True, verbose_name='Брачное состояние'),
        ),
        migrations.AlterField(
            model_name='medicalcard',
        ...
        migrations.AlterField(
            ...
            name='outcome',
            field=models.CharField(blank=True, choices=[('3', 'Самопроизовльный выкидыш'), ('', '-----'), ('1', 'Срочные/Преждевременные'), ('4', 'Искусственный аборт'), ('6', 'Пузырный занос'), ('5', 'Неразвивающаяся беременность'), ('2', 'Кесарево сечение')], max_length=10, null=True, verbose_name='Исход беременности'),
        ),
        migrations.AlterField(
            model_name='previouspregnancy',
        ...
        migrations.AlterField(
            ...
            name='specialization',
            field=models.CharField(blank=True, choices=[('assistant', 'Лаборант'), ('pediator', 'Педиатр'), ('', ''), ('therapist', 'Терапевт'), ('nurse', 'Медсестра'), ('receptionist', 'Регистратор'), ('obstetrician-gynecologist', 'Акушер-гинеколог'), ('ophthalmologist', 'Офтальмолог'), ('specialist', 'Специалист'), ('dentist', 'Стоматолог')], max_length=30, null=True, verbose_name='Специальность врача'),
        ),
        migrations.AlterField(
            model_name='samd',
            name='sms_status',
            field=models.CharField(blank=True, choices=[('2', 'Неправильно введены данные'), ('', '-----'), ('5', 'Отправлен'), ('3', 'Не подписан'), ('1', 'Недостаточно данных'), ('4', 'Готов к отправке')], max_length=300, verbose_name='Статус версии СМС'),
        ),
        migrations.AlterField(
            model_name='samd',
            name='sms_type',
            field=models.CharField(blank=True, choices=[('2', 'Выявление госпитализации (получение пациентом медицинской помощи в условиях стационара (дневного стационара))'), ('', '-----'), ('1', 'Направление на оказание медицинских услуг')], max_length=10, verbose_name='Тип СМС'),
        ),
        migrations.AlterField(
